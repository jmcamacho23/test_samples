...
nyc_url_alias = 'lat=40.714270000000056&lon=-74.00596999999993'
la_url_alias = 'lat=34.052238&lon=-118.243344'
gb_url = 'lat=44.5133&lon=-88.0133'

urls_alias_dictionary = {'NYC': f'{nyc_url_alias}', 'LA': f'{la_url_alias}',
                         'Green Bay': f'{gb_url}'}
...
for name, url in urls_alias_dictionary.items():
    ...
    time_observed = soup.find('div', id='current_conditions_detail').find_all('tr')[5].text
